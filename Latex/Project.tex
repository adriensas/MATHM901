...
\pagebreak
\appendix
\includepdf[scale=0.95,pages=1,pagecommand=\section{Appendix : Mathematica}\subsection{Schwarshild Case}, offset=0 -3cm]{SchwarzchildCase.pdf}
\includepdf[scale=0.95,pages=1,pagecommand=\subsection{Kerr Case}, offset=0 -3cm]{KerrAppendix.pdf}
\includepdf[scale=1,pages=2-,pagecommand=,offset=0 -2cm]{KerrAppendix.pdf}
